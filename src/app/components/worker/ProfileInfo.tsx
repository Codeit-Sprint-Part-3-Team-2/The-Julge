...
// 프로필 컴포넌트
const ProfileInfo = ({ onButtonClick }: ProfileInfoProps) => {
  return (
      ...
      <div className="w-full rounded-xl bg-red-10 p-5 text-sm sm:p-8 sm:text-base lg:max-w-2xl">
        <div className="relative flex flex-col gap-2 sm:gap-3">
          <div className="font-bold">
            <p className="mb-2 text-orange">아름</p>
            <p className="text-2xl sm:text-[1.75rem]">김민우</p>
          </div>

          <div className="flex items-center text-gray-50">
            <div className="relative mr-[0.375rem] size-4 sm:size-5">
              <Image src="/worker/ic-mobile.svg" alt="지역" fill className="object-contain" />
            </div>
            <p>010-1234-4321</p>
          </div>
          ...
          <p className="mt-3 sm:mt-4">열심히 일하겠습니다.</p>
